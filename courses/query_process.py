...
prompt_main = ChatPromptTemplate.from_messages([
    ("system",
     ...
     "you should reference this code as a main context for user query to provide more ground and presise answers"
     "Alone with code you are provided with file name this code is opened from"
     "Code may be accompanied with UI image screen-shoted form the user rendered UI by the platform"
     "UI Screenshot goes along with the code message in the next or previous message"
